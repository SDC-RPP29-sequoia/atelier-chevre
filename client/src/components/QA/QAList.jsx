            ...
            return (
              <div key={q.question_date + i} className="qa" id="list">
                ...
                <div>{answers.map(a => {
                  ...
                  return (
                    <AnswerContainer key={a.id} body={a.body} photos={a.photos} aName={aName} date={date} nswerHelpful={this.answerHelpful} answer_id={a.id} helpfulness={a.helpfulness} answerReport={this.answerReport} />
                  );
                })}
                <br></br>
