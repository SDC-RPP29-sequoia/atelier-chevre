...
const SignatureHelpfulReport = (props) => {
  return (
    <div className="signature-helpful-report">
      ...
      <u className="answer-helpful" onClick={props.answerHelpful} answer_id={props.answer_id} clicked="false">Yes</u>
      <div>&nbsp;({props.helpfulness}) |&nbsp;</div>
      <u className="report-answer" onClick={props.answerReport} answer_id={props.answer_id}>Report</u>
    </div>
  );
};
